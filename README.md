...
* A dockerized postgres db is part of the docker-compose file. <b>You need to manually enable the age and vector extensions for the lightrag to work!</b> This only needs to happen once.
